 ...
 * @author l.frattini
 */
public class RockEatUI extends javax.swing.JFrame implements ActionListener,
	...
	private void enableOrDisableButton() {
		...
		Boolean enabled = StringUtils.isNotBlank(urlToParse)
				&& ParsingUtils.isValidUrl(urlToParse);
	...
	public void startParsing(String url) {
		try {
			...
			JOptionPane.showMessageDialog(this, Messages.ERROR_URL,
					Messages.TITLE, 1);
			reset();
		} catch (Exception e) {
			JOptionPane.showMessageDialog(this, Messages.ERROR_UNEXPECTED,
					Messages.TITLE, 0);
			reset();
		}
	}
	...
	private void initComponents() {
		...
		sourcePanelLayout
				.setHorizontalGroup(sourcePanelLayout
						.createParallelGroup(
						...
						.addGroup(
								sourcePanelLayout
										...
										.addContainerGap()));
		sourcePanelLayout
				.setVerticalGroup(sourcePanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								sourcePanelLayout
